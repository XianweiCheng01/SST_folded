...
void graph_500_class::make_graph(int log_numverts, int64_t M, uint64_t userseed1, uint64_t userseed2, int64_t* nedges_ptr_in, packed_edge** result_ptr_in) {
 ...
 * random-access) way. */
void graph_500_class::make_random_numbers(

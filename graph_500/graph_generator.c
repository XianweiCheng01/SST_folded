...
int graph_500_class::generate_4way_bernoulli(mrg_state* st, int level, int nlevels) {
 ...
 * */
inline uint64_t graph_500_class::bitreverse(uint64_t x) {
...
inline int64_t graph_500_class::scramble(int64_t v0, int lgN, uint64_t val0, uint64_t val1) {
...
void graph_500_class::make_one_edge(int64_t nverts, int level, int lgN, mrg_state* st, packed_edge* result, uint64_t val0, uint64_t val1) {
...
void graph_500_class::generate_kronecker_range(

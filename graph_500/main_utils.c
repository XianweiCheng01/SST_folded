...
void graph_500_class::setup_globals() {
	...
	//printf("Create_hindexed is running...3\n");
...
void* graph_500_class::xMPI_Alloc_mem(size_t nbytes) {
	void* p;

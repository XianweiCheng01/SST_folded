...
#define SST_INSTALL_PREFIX "/home/xianwei/local/sstcore-11.0.0"
...
#define SST_PYTHON_CPPFLAGS "-I/usr/include/python3.7m -I/usr/include/python3.7m"

/* Defines the LDFLAGS needed to compile Python into SST */
#define SST_PYTHON_LDFLAGS "-L/usr/lib/python3.7/config-3.7m-x86_64-linux-gnu -L/usr/lib -lpython3.7m -lcrypt -lpthread -ldl  -lutil -lm  -Xlinker -export-dynamic -Wl,-O1 -Wl,-Bsymbolic-functions"

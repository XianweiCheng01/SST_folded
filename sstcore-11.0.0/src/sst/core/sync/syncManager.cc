...
{
    // printf("Test 0 in SyncManager::execute of syncManager.cc\n");
    fflush(stdout);
    switch ( next_sync_type ) {
    case RANK:
        // printf("Test 00 in SyncManager::execute of syncManager.cc\n");
        fflush(stdout);
        ...
        break;
    case THREAD:
        // printf("Test 01 in SyncManager::execute of syncManager.cc\n");
        fflush(stdout);
    ...
    // printf("Test 1 in SyncManager::execute of syncManager.cc\n");
    fflush(stdout);
    computeNextInsert();
    RankExecBarrier[5].wait();
    // printf("Test 2 in SyncManager::execute of syncManager.cc\n");
    fflush(stdout);
}
...
{
    // printf("Test 0 in computeNextInsert() of syncManager.cc\n");
    fflush(stdout);
    ...
    // printf("Test 1 in computeNextInsert() of syncManager.cc\n");
    fflush(stdout);
}

...
{
    // printf("Test 0 in setStopAtCycle of simulation.cc\n");
    fflush(stdout);
    ...
    // printf("Test 1 in setStopAtCycle of simulation.cc\n");
    fflush(stdout);
}
...
{
    // printf("Test 0 in performWireUp of simulation.cc\n");
    fflush(stdout);
...
//    graph.links.clear();
    ...
    {
        ConfigComponent* ccomp = *iter;
	// printf("Test 20 in performWireUp of simulation.cc\n");
	fflush(stdout);
	...
	// printf("Test 21 in performWireUp of simulation.cc\n");
	fflush(stdout);
    } // end for all vertex
    ...
    */
    wireUpFinished = true;
    // printf("Test 4 in performWireUp of simulation.cc\n");
    fflush(stdout);
...
void Simulation_impl::initialize() {
    // printf("Test 0 in initialize of simulation.cc\n");
    fflush(stdout);
    bool done = false;
    initBarrier.wait();
    if ( my_rank.thread == 0 ) {
    ...
    // printf("Test 1 in initialize of simulation.cc\n");
    fflush(stdout);
    ...
    // printf("Test 2 in initialize of simulation.cc\n");
    fflush(stdout);

    // Walk through all the links and call finalizeConfiguration

    for ( auto &i : compInfoMap ) {
	// printf("Test 20 in initialize of simulation.cc\n");
	fflush(stdout);
        i->finalizeLinkConfiguration();
	// printf("Test 21 in initialize of simulation.cc\n");
	fflush(stdout);
    }
#if 0
...
#endif
    // printf("Test 3 in initialize of simulation.cc\n");
    fflush(stdout);
    syncManager->finalizeLinkConfigurations();
    // printf("Test 4 in initialize of simulation.cc\n");
    fflush(stdout);
...
void Simulation_impl::run() {
    ...
    // printf("Test 0 in run of simulation.cc\n");
    fflush(stdout);
    StopAction* sa = new StopAction("*** Event queue empty, exiting simulation... ***");
    sa->setDeliveryTime(SST_SIMTIME_MAX);
    // printf("Test 1 in run of simulation.cc\n");
    fflush(stdout);
    timeVortex->insert(sa);

    // printf("Test 2 in run of simulation.cc\n");
    fflush(stdout);
    ...
    // printf("Test 3 in run of simulation.cc\n");
    fflush(stdout);
    ...
    // printf("Test 4 in run of simulation.cc\n");
    fflush(stdout);
    ...
    header += ":  ";
    while( LIKELY( ! endSim ) ) {
        // printf("Test 5 in run of simulation.cc\n");
        fflush(stdout);
        current_activity = timeVortex->pop();
        // printf("Test 6 in run of simulation.cc\n");
        fflush(stdout);
        currentSimCycle = current_activity->getDeliveryTime();
        currentPriority = current_activity->getPriority();
        // printf("Test 7 in run of simulation.cc\n");
        fflush(stdout);
        current_activity->execute();
        // printf("Test 8 in run of simulation.cc\n");
        fflush(stdout);
...
void Simulation_impl::insertActivity(SimTime_t time, Activity* ev) {
    // printf("Test 0 in insertActivity of simulation.cc\n");
    fflush(stdout);
    ev->setDeliveryTime(time);
    timeVortex->insert(ev);
    // printf("Test 1 in insertActivity of simulation.cc\n");
    fflush(stdout);

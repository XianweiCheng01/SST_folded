...
static void do_graph_wireup(ConfigGraph* graph,
    ...
    // printf("Test 0 in do_graph_wireup of main.cc, performwireup\n");
    fflush(stdout);
    sim->performWireUp( *graph, myRank, min_part );
    // printf("Test 1 in do_graph_wireup of main.cc, performwireup\n");
    fflush(stdout);
...
{
    printf("----------Test 0 in start_simulation of main.cc----------\n");
    fflush(stdout);
    ...
    printf("----------Test 1 in start_simulation of main.cc----------\n");
    fflush(stdout);
    ...
    printf("----------Test 2 in start_simulation of main.cc----------\n");
    fflush(stdout);
    sim->processGraphInfo( *info.graph, info.myRank, info.min_part );

    barrier.wait();

    printf("----------Test 3 in start_simulation of main.cc----------\n");
    fflush(stdout);
    ...
    printf("----------Test 4 in start_simulation of main.cc----------\n");
    fflush(stdout);
    if ( tid == 0 ) {
    ...
    printf("----------Test 5 in start_simulation of main.cc----------\n");
    fflush(stdout);
    if ( info.config->runMode == Simulation::RUN || info.config->runMode == Simulation::BOTH ) {
        ...
        barrier.wait();
        printf("----------Test 6 in start_simulation of main.cc----------\n");
        fflush(stdout);

        sim->initialize();
        barrier.wait();
        printf("----------Test 7 in start_simulation of main.cc----------\n");
        fflush(stdout);

        /* Run Set */
        sim->setup();
        barrier.wait();
        printf("----------Test 8 in start_simulation of main.cc----------\n");
        fflush(stdout);

        /* Run Simulation */
        sim->run();
        barrier.wait();
        printf("----------Test 9 in start_simulation of main.cc----------\n");
        fflush(stdout);

        sim->complete();
        barrier.wait();
        printf("----------Test 10 in start_simulation of main.cc----------\n");
        fflush(stdout);

        sim->finish();
        barrier.wait();
        printf("----------Test 11 in start_simulation of main.cc----------\n");
        fflush(stdout);
    }

    barrier.wait();
    printf("----------Test 12 in start_simulation of main.cc----------\n");
    fflush(stdout);
    ...
    printf("----------Test 13 in start_simulation of main.cc----------\n");
    fflush(stdout);

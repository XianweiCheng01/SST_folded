...
{
    // printf("Test 0 in Exit::refDec of exit.cc\n");
    fflush(stdout);
    ...
    // printf("Test 1 in Exit::refDec of exit.cc\n");
    fflush(stdout);
...
Exit::execute()
{
    // printf("Test 0 in Exit::execute of exit.cc\n");
    fflush(stdout);
    check();
    ...
    // printf("Test 1 in Exit::execute of exit.cc\n");
    fflush(stdout);

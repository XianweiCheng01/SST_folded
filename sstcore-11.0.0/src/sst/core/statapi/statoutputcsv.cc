...
void StatisticOutputCSV::startOfSimulation()
{
    ...
    printf("Test 0 in startOfSimulation() of statoutputcsv.cc\n");
    fflush(stdout);
    ...
    // printf("Test 1 in startOfSimulation() of statoutputcsv.cc\n");
    fflush(stdout);
    ...
    // printf("Test 2 in startOfSimulation() of statoutputcsv.cc\n");
    fflush(stdout);
    ...
    // printf("Test 3 in startOfSimulation() of statoutputcsv.cc\n");
    fflush(stdout);
    ...
    // printf("Test 4 in startOfSimulation() of statoutputcsv.cc\n");
    fflush(stdout);
}

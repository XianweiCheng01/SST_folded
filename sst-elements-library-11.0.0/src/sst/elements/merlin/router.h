...
public:
	...
	// printf("Test 0 in BaseRtrEvent:serialize_order of router.h\n");
	fflush(stdout);
        Event::serialize_order(ser);
	// printf("Test 1 in BaseRtrEvent:serialize_order of router.h\n");
	fflush(stdout);
        ser & type;
	// printf("Test 2 in BaseRtrEvent:serialize_order of router.h\n");
	fflush(stdout);
    }
...
public:
    ...
    void serialize_order(SST::Core::Serialization::serializer &ser)  override {
	// printf("Test 0 in internal_router_event::serialize_order of router.h\n");
	fflush(stdout);
        BaseRtrEvent::serialize_order(ser);
	// printf("Test 1 in internal_router_event::serialize_order of router.h\n");
	fflush(stdout);
        ser & next_port;
	// printf("Test 2 in internal_router_event::serialize_order of router.h\n");
	fflush(stdout);
        ser & next_vc;
	// printf("Test 3 in internal_router_event::serialize_order of router.h\n");
	fflush(stdout);
        ser & vc;
	// printf("Test 4 in internal_router_event::serialize_order of router.h\n");
	fflush(stdout);
        ser & credit_return_vc;
	// printf("Test 5 in internal_router_event::serialize_order of router.h\n");
	fflush(stdout);
        ser & encap_ev;
	// printf("Test 6 in internal_router_event::serialize_order of router.h\n");
	fflush(stdout);
    }

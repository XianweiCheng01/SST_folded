        ...
        for i in range(num_routers):
            ...
            for dim in range(self.nd):
                ...
                for num in range(self.dimwidths[dim]):
                    print("Test 10 in for loop wid, port ", num, port)
                    print(mylocstr)
                    print(theirlocstr)
                ...
                theirlocstr = self._formatShape(theirdims)
                for num in range(self.dimwidths[dim]):
                    print("Test 11 in for loop wid, port ", num, port)
                    print(theirlocstr)
                    print(mylocstr)
            ...
            for n in range(_params["torus:local_ports"]):
                print("Test 2 in for loop lport_id ", n)
                ...
                if ep:
                    ...
                    if self.bundleEndpoints:
                       nicLink.setNoCut()
                    print("Test 20 in for loop port ", port)
...
class TrafficGenEndPoint(EndPoint):
    ...
    def build(self, nID, extraKeys):
        ...
        nic.addParams(_params.subset(extraKeys, {}))
        print("Test ---------------0 in ep build of pymerlin.py")
        print(_params.subset(self.epKeys, self.epOptKeys))
        print(_params.subset(self.nicKeys))
        print(_params.subset(extraKeys, {}))
        print("Test ---------------1 in ep build of pymerlin.py")

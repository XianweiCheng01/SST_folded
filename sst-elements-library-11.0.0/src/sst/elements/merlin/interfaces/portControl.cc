...
{
    // printf("Test 00 in portControl.cc\n");
    fflush(stdout);
...
{
    // printf("Test 01 in portControl.cc\n");
    fflush(stdout);
...
{
    // printf("Test 02 in portControl.cc\n");
    fflush(stdout);
#if TRACK
...
{
    // printf("Test 03 in portControl.cc\n");
    fflush(stdout);
...
{
    // printf("Test 04 in portControl.cc\n");
    fflush(stdout);
#if TRACK
    if ( rtr_id == TRACK_ID && port_number == TRACK_PORT ) {
        printStatus(Simulation::getSimulation()->getSimulationOutput(),0,0);
...
{
    // printf("Test 05 in portControl.cc\n");
    fflush(stdout);
    ...
    total_incast_flits(0)
{
    ...
    // printf("Test 06 in portControl.cc %s\n", link_port_name.c_str());
    fflush(stdout);
    ...
    case Topology::R2N:
    	// printf("Test 06 0 in portControl.cc\n");
    	fflush(stdout);
        host_port = true;
        ...
        if ( port_link != NULL ) {
    	// printf("Test 06 0 1 in portControl.cc\n");
    	fflush(stdout);
    ...
    case Topology::FAILED:
    	...
    	// printf("Test 06 1 in portControl.cc\n");
    	fflush(stdout);
        host_port = false;
        port_link = configureLink(link_port_name, output_latency_timebase,
                                  new Event::Handler<PortControl>(this,&PortControl::handle_input_r2r));
        if ( port_link != NULL ) {
    	// printf("Test 06 1 1 in portControl.cc\n");
    	fflush(stdout);
            output_timing = configureSelfLink(link_port_name + "_output_timing", "1GHz",
                                              new Event::Handler<PortControl>(this,&PortControl::handle_output));
        }
        break;
    default:
    	// printf("Test 06 2 in portControl.cc\n");
    	fflush(stdout);
        host_port = false;
        port_link = NULL;
        break;
    ...
    if ( port_link == NULL ) {
    	...
    	// printf("Test 06 3 in portControl.cc\n");
    	fflush(stdout);
    ...
    congestion_events = 0;
    	...
    	// printf("Test 06 4 in portControl.cc\n");
    	fflush(stdout);
}
...
{
    // printf("Test 07 in portControl.cc\n");
    fflush(stdout);
    ...
    // printf("Test 071 in portControl.cc\n");
    fflush(stdout);
}
...
void
PortControl::setup() {
    // printf("Test 08 in portControl.cc\n");
    fflush(stdout);
    if ( !connected ) return;
...
void
PortControl::finish() {
    // printf("Test 09 in portControl.cc\n");
    fflush(stdout);
    if ( !connected ) return;
...
PortControl::init(unsigned int phase) {
    // printf("Test 10 in portControl.cc\n");
    fflush(stdout);
    if ( !connected ) return;
    // printf("Test 10 in portControl.cc start %d\n", phase);
    fflush(stdout);
    Event *ev;
    ...
    switch ( phase ) {
    case 0:
    // printf("Test 100 in portControl.cc start %d\n", phase);
    fflush(stdout);
    ...
    // printf("Test 10 in portControl.cc done\n");
    fflush(stdout);
}

void
PortControl::complete(unsigned int phase) {
    // printf("Test 11 in portControl.cc\n");
    fflush(stdout);
    if ( !connected ) return;
    Event *ev;
...
{
    // printf("Test 12 in portControl.cc\n");
    fflush(stdout);
    sendUntimedData(ev);
}
...
{
    // printf("Test 13 in portControl.cc\n");
    fflush(stdout);
...
{
    // printf("Test 14 in portControl.cc\n");
    fflush(stdout);
    if ( connected ) {
        port_link->sendInitData(ev);
    }
...
{
    // printf("Test 15 in portControl.cc\n");
    fflush(stdout);
    if ( connected && init_events.size() ) {
    // printf("Test 15 0 in portControl.cc\n");
    fflush(stdout);
...
{
    // printf("Test 0 in handle_input_n2r of portControl.cc\n");
    fflush(stdout);
    ...
    {
    	// printf("Test 00 in handle_input_n2r of portControl.cc\n");
    	fflush(stdout);
	...
	{
    	// printf("Test 01 in handle_input_n2r of portControl.cc\n");
    	fflush(stdout);
    	...
    	// printf("Test 02 in handle_input_n2r of portControl.cc rec on port %d in router %d(%s) on VC %d from src %d\n to dest %d\n", port_number, rtr_id, getName().c_str(), curr_vc, event->getTrustedSrc(), event->getDest());
    	fflush(stdout);
	...
	case BaseRtrEvent::CTRL:
    	// printf("Test 02 in handle_input_n2r of portControl.cc\n");
    	fflush(stdout);
    ...
    // printf("Test 1 in handle_input_n2r of portControl.cc\n");
    fflush(stdout);
}
...
{
    // printf("Test 0 in handle_input_r2r of portControl.cc\n");
    fflush(stdout);
#if TRACK
    if ( rtr_id == TRACK_ID && port_number == TRACK_PORT ) {
...
#endif
    // printf("Test 1 in handle_input_r2r of portControl.cc\n");
    fflush(stdout);
}

void
PortControl::handle_output(Event* ev) {
    // printf("Test 0 in handle_output of portControl.cc\n");
    fflush(stdout);
#if TRACK
    if ( rtr_id == TRACK_ID && port_number == TRACK_PORT ) {
        printStatus(Simulation::getSimulation()->getSimulationOutput(),0,0);
...
#endif
    // printf("Test 1 in handle_output of portControl.cc\n");
    fflush(stdout);
}

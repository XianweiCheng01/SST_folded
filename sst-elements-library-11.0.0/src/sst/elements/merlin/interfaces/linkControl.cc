...
LinkControl::LinkControl(ComponentId_t cid, Params &params, int vns) :
    ...
    sent(0)
{
    // printf("Test 0 in LinkControl of linkControl.cc\n");
    fflush(stdout);
    ...
    last_time = 0;
    last_recv_time = 0;
    // printf("Test 1 in LinkControl of linkControl.cc\n");
    fflush(stdout);
}
...
void LinkControl::init(unsigned int phase)
{
    ...
    // printf("Test 0 in init of linkControl.cc for phase: %d\n", phase);
    fflush(stdout);
    switch ( phase ) {
    case 0:
    {
    ...
    // printf("Test 1 in init of linkControl.cc for phase: %d\n", phase);
        rtr_link->sendUntimedData(init_ev);
    // printf("Test 2 in init of linkControl.cc for phase: %d\n", phase);
    ...
    // printf("Test 3 in init of linkControl.cc for phase: %d\n", phase);
        rtr_link->sendUntimedData(ev);
    // printf("Test 4 in init of linkControl.cc for phase: %d\n", phase);
    }
        break;
    case 1:
    {
    ...
    // printf("Test 1 in init recv of linkControl.cc for phase: %d\n", phase);
    ...
    // printf("Test 2 in init recv of linkControl.cc for phase: %d\n", phase);
        ev = rtr_link->recvUntimedData();
        init_ev = dynamic_cast<RtrInitEvent*>(ev);
    ...
    // printf("Test 3 in init recv of linkControl.cc for phase: %d\n", phase);
        ev = rtr_link->recvUntimedData();
        if ( ev == nullptr ) {
            // fail
        }
    ...
    fflush(stdout);
        ev = rtr_link->recvUntimedData();
    // printf("Test 1-2 in init of linkControl.cc for phase: %d\n", phase);
    fflush(stdout);
        init_ev = dynamic_cast<RtrInitEvent*>(ev);
    ...
    // printf("Test 5 in init of linkControl.cc for phase: %d\n", phase);
    ...
    // printf("Test 6 in init of linkControl.cc for phase: %d\n", phase);
    ...
    // printf("Test 7 in init of linkControl.cc for phase: %d\n", phase);
        ...
        for ( int i = 0; i < total_vns; i++ ) {
            ...
            if ( credits > 0 ) {
    // printf("Test 7 0 in init for loop of LinkControl.cc\n");
    fflush(stdout);
    ...
    // printf("Test 8 in init of linkControl.cc for phase: %d\n", phase);
        break;
    default:
    ...
    // printf("Test 8 in init default of linkControl.cc for phase: %d\n", phase);
...
void LinkControl::complete(unsigned int phase)
{
    ...
    Event* ev;
    RtrInitEvent* init_ev;
    // printf("Test 0 in complete of linkControl.cc for phase: %d\n", phase);
    while ( ( ev = rtr_link->recvUntimedData() ) != nullptr ) {
        BaseRtrEvent* bev = static_cast<BaseRtrEvent*>(ev);
        switch (bev->getType()) {
        case BaseRtrEvent::PACKET:
...
bool LinkControl::send(SimpleNetwork::Request* req, int vn) {
    ...
    // printf("Test 0 in send of LinkControl.cc\n");
    fflush(stdout);
    ...
    // printf("Test 1 in send of LinkControl.cc\n");
    fflush(stdout);
    ...
    // printf("Test 2 in send of LinkControl.cc\n");
    fflush(stdout);
    // Fill in the number of flits
    ev->computeSizeInFlits(flit_size);
    // printf("Test 3 in send of LinkControl.cc\n");
    fflush(stdout);
    int flits = ev->getSizeInFlits();
    // printf("Test 4 in send of LinkControl.cc\n");
    fflush(stdout);
    ...
    // printf("Test 9 in send of LinkControl.cc\n");
    fflush(stdout);
    return true;
}
...
SST::Interfaces::SimpleNetwork::Request* LinkControl::recv(int vn) {
    // printf("Test 0 in recv of LinkControl.cc\n");
    fflush(stdout);
    ...
    delete event;
;
    // printf("Test 1 in recv of LinkControl.cc\n");
    fflush(stdout);
    return ret;
}
...
void LinkControl::sendUntimedData(SST::Interfaces::SimpleNetwork::Request* req)
{
    ...
    // printf("Test 0 in sendUntimedData of LinkControl.cc\n");
    fflush(stdout);
...
{
// printf("Test 0 in recvUntimedData of linkControl.cc\n");
fflush(stdout);
    if ( init_events.size() ) {
// printf("Test 1 in recvUntimedData of linkControl.cc\n");
fflush(stdout);
        RtrEvent *ev = init_events.front();
        init_events.pop_front();
// printf("Test 2 in recvUntimedData of linkControl.cc\n");
fflush(stdout);
        SST::Interfaces::SimpleNetwork::Request* ret = ev->takeRequest();
// printf("Test 3 in recvUntimedData of linkControl.cc\n");
fflush(stdout);
        delete ev;
        return ret;
    } else {
...
void LinkControl::sendInitData(SST::Interfaces::SimpleNetwork::Request* req) {
    // printf("Test 0 in sendInitData of LinkControl.cc\n");
    fflush(stdout);
    sendUntimedData(req);
}
...
void LinkControl::handle_output(Event* ev)
{
    ...
    // printf("Test 0 in handle_output of LinkControl.cc\n");
    fflush(stdout);
    ...
    have_packets = false;
    // printf("Test 00 in handle_output of LinkControl.cc\n");
    fflush(stdout);
    ...
    // printf("Test 01 in handle_output of LinkControl.cc\n");
    fflush(stdout);
    ...
    // printf("Test 02 in handle_output of LinkControl.cc\n");
    fflush(stdout);
    // If we found an event to send, go ahead and send it
    if ( found ) {
    	// printf("Test 020 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
    	...
    	// printf("Test 020-0 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
        output_timing->send(size,nullptr);
    	// printf("Test 020-1 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
    	...
    	// printf("Test 0200 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
        rtr_link->send(send_event);
        last_recv_time = getCurrentSimCycle();
        sent++;
    	// printf("Test 0201 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
    	...
    	// printf("Test 0202 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
        if (sendFunctor != nullptr ) {
            bool keep = (*sendFunctor)(send_event->getLogicalVN());
            if ( !keep ) sendFunctor = nullptr;
        }
    	// printf("Test 021 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
    }
    else {
    	// printf("Test 022 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
    	...
    	// printf("Test 023 in handle_output of LinkControl.cc\n");
    	fflush(stdout);
    }
    // printf("Test 1 in handle_output of LinkControl.cc\n");
    fflush(stdout);
}
